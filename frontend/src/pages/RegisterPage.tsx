  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        <h1 className="mb-1 text-center text-2xl font-bold text-zinc-100">Groundwork</h1>
        <p className="mb-6 text-center text-zinc-400">Create your account</p>
        <form onSubmit={onSubmit} className="space-y-4 rounded-xl border border-zinc-800 bg-zinc-900 p-6 shadow-sm">
          ...
          <label className="block">
            <span className="mb-1 block text-sm font-medium text-zinc-300">Confirm password</span>
            <PasswordInput
              value={confirm}
              onChange={setConfirm}
              minLength={8}
          ...
          <button
            ...
            className="w-full rounded-lg bg-violet-500 py-2 font-medium text-white hover:bg-violet-400 disabled:opacity-50"
          >
